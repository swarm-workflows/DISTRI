...
class DTN:
    ...
    def set_data_source_dtn(self, source_dtn):
        """Sets the source DTN for data requests in dumbell topology."""
        self.data_source_dtn = source_dtn
        print(f"DTN {self.dtn_id} will request data from DTN {source_dtn.dtn_id}")
