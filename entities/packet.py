class Packet:
    def __init__(self, source, destination, packet_type, packet_size=1, segment_seq=None, segment_flag=None, segment_ack=None, job_id=None, data=0, data_volume=0, connection_id=None, connection = None, missing_segments=None):
        self.source = source
        ...
        self.job_id = job_id          # Default is none if not specified
    ...
    def __repr__(self):
        return (f"Packet(type={self.packet_type}, size={self.packet_size}, segment_seq={self.segment_seq}, segment_flag={self.segment_flag}, segment_ack={self.segment_ack}, job_id={self.job_id}, "
